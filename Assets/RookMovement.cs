...
public class RookMovement : MonoBehaviour
{
    ...
    public static RookMovement rookInstance;
       ...
       if(canMove == true)
        {
            ...
            {
                if ((transform.position.x + 1f) == targetPosition.position.x && transform.position.y == targetPosition.position.y)
                {
                    movePoint += new Vector3(1f, 0f, 0f);
                    canMove = false;
                }
                else if ((transform.position.x - 1f) == targetPosition.position.x && transform.position.y == targetPosition.position.y)
                {
                    movePoint += new Vector3(-1f, 0f, 0f);
                    canMove = false;
                }
                else if ((transform.position.y + 1f) == targetPosition.position.y && transform.position.x == targetPosition.position.x)
                {
                ...
                else if (Mathf.Abs(Mathf.Abs(targetPosition.position.y) - Mathf.Abs(transform.position.y)) > Mathf.Abs(Mathf.Abs(targetPosition.position.x) - Mathf.Abs(transform.position.x)))
                {
                    ...
                    else if (transform.position.y < targetPosition.position.y)
                    {
                        movePoint += new Vector3(0f, 1f, 0f);
                        canMove = false;
                    }
                ...
                else if (Mathf.Abs(Mathf.Abs(targetPosition.position.y) - Mathf.Abs(transform.position.y)) < Mathf.Abs(Mathf.Abs(targetPosition.position.x) - Mathf.Abs(transform.position.x)))
                {
                    ...
                    else if (transform.position.x > targetPosition.position.x)
                    {
                        movePoint += new Vector3(-1f, 0f, 0f);
                        canMove = false;
                    }
